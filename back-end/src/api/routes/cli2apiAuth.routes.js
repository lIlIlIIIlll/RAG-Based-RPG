...
// Handle manual OAuth callback submission
router.post("/manual-callback", cli2apiAuthController.manualCallback);

// Handle OAuth callback from provider (Legacy/Disabled)
